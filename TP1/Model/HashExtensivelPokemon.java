...
public class HashExtensivelPokemon {
    ...
    public HashExtensivelPokemon(int quantidadeDadosPorCesto, String nomeArquivoDiretorio, String nomeArquivoCestos)
            throws Exception {
        // Atruição
    ...
    class Cesto {
        ...
        private int bytesPorCesto; // size fixo do cesto em bytes
        ...
        public Cesto(int quantidadeMaxima, int profundidadeLocal) throws Exception {
            ...
            this.bytesPorCesto = (bytesPorPar * quantidadeMaxima + 3);
        }
